                ...
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4">Find A <span class="text-success"> Perfect Boarding </span> To Live! </h1>
                            <h4> We don't want to sell you a <span class="text-success">House</span>, We wan't you to find a 
                            <span class="text-success">Home</span>. </h4><br><br>
                            <a href="filterproperty.php"><button type="button" name="filter" class="btn btn-success w-100">Search Property</button></a>
                            </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-medal text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Guess Better Place</a></h5>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-payment text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Payment Service</a></h5>
								...
								<h4 class="text-secondary double-down-line text-center mb-4">Feedbacks</h4>
									<div class="recent-review owl-carousel owl-dots-gray owl-dots-hover-success">
										...
										<div class="item">
											...
											<div class="p-2 mt-4">
												<span class="text-success d-table text-capitalize"><?php echo $row['uname']; ?>
											</div>
										</div>
										<?php }  ?>
									</div>
